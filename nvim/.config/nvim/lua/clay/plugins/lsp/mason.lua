return {
	...
	config = function()
        ...
        -- Global diagnostic config (Disable warnings, hints, info)
						...
						python = {
							analysis = {
								...
								diagnosticSeverityOverrides = {
									...
									reportOptionalSubscript = "basic",
									reportOptionalMemberAccess = "basic",
									reportUnusedVariable = "basic",
								},
							},
						},
					},
			...
			["pylsp"] = function()
				lspconfig.pylsp.setup({
					...
					settings = {
						pylsp = {
							plugins = {
								pyflakes = { enabled = true }, -- Disable warnings
								pycodestyle = { enabled = false }, -- Disable linting hints
								mccabe = { enabled = true }, -- Disable complexity checks
							},
						},
					},
				})
